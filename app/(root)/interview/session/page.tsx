  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-8">
        ...
        <div className="bg-white rounded-[2rem] p-8 border border-gray-200 shadow-md flex flex-col items-center justify-center h-64 gap-4">
      ...
      <div className="bg-white rounded-[2rem] p-8 border border-gray-200 shadow-md">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-gray-800 font-medium text-lg">{interview?.type} Interview</h3>
              <div className="inline-flex items-center gap-2 bg-teal-100 rounded-full px-3 py-1 w-fit mt-1">
                ...
                <span className="text-teal-600 text-xs font-medium">AI Interviewer</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col items-end gap-1">
            <span className="text-sm text-gray-600 font-medium">Question {currentQuestion}/{totalQuestions}</span>
