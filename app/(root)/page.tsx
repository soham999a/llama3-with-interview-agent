...
function Home() {
  ...
  const currentInterviews = userInterviews?.slice(
    indexOfFirstInterview,
    indexOfLastInterview
  );
  const totalPages = Math.ceil(
    (userInterviews?.length || 0) / interviewsPerPage
  );
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-teal-50 to-teal-100/20 rounded-md p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 border border-teal-100 shadow-md">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
          <div className="flex flex-col gap-6 max-w-lg w-full">
            <div className="inline-flex items-center gap-2 bg-[#1EBBA3]/10 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 w-fit">
              <span className="animate-pulse size-2 bg-[#1EBBA3] rounded-full"></span>
              <span className="text-[#1EBBA3] text-xs sm:text-sm font-medium">
            ...
            <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed">
              Practice real interview questions with our LLAMA3-powered AI
              interviewer and receive personalized feedback to enhance your
              skills.
            </p>
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-2">
              <div className="flex -space-x-2">
                <div className="size-7 sm:size-8 rounded-full bg-[#1EBBA3] flex items-center justify-center text-white text-xs font-bold">
                  AI
                </div>
                <div className="size-7 sm:size-8 rounded-full bg-[#18A08B] flex items-center justify-center text-white text-xs font-bold">
                  ML
                </div>
                <div className="size-7 sm:size-8 rounded-full bg-[#148F7C] flex items-center justify-center text-white text-xs font-bold">
                  NLP
                </div>
              </div>
          ...
          <div className="relative w-full max-w-[220px] xs:max-w-[250px] sm:max-w-[280px] md:max-w-[320px]">
            <div className="absolute inset-0 bg-gradient-to-r from-[#1EBBA3]/20 to-[#18A08B]/20 rounded-full blur-xl"></div>
          ...
          {interviewTypes.map((type) => (
            ...
            >
              ...
              >
                ...
                <h3 className="mt-5 text-xl font-semibold text-gray-800 group-hover:text-gray-900 transition-colors duration-300">
                  {type.title}
                </h3>
            ...
            <div className="relative overflow-hidden rounded-[var(--radius)] bg-white p-4 sm:p-6 md:p-8 text-center col-span-2 border border-gray-200 shadow-md">
              ...
              <div className="flex flex-col items-center justify-center gap-4 relative z-10">
                ...
                <p className="text-gray-600 max-w-md mt-2">
                  Complete your first interview to see your history and
                  performance analytics here. Get personalized feedback to
                  improve your skills.
                </p>
        ...
        <div className="flex flex-col gap-6 sm:gap-8 md:flex-row md:items-center md:justify-between relative z-10">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-teal-100 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 w-fit mb-3 sm:mb-4">
              <span className="animate-pulse size-2 bg-teal-500 rounded-full"></span>
              <span className="text-teal-600 text-xs sm:text-sm font-medium">
                Now Available
              </span>
            </div>
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              Explore different job opportunities and prepare for your
              interviews:
            </p>
