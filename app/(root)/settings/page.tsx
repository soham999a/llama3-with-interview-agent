        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between py-3 border-b border-dark-300">
            <div>
              ...
              <p className="text-light-400 text-sm">Enable 3D elements for a more immersive experience</p>
            </div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-dark-300">
            <div>
              ...
              <p className="text-light-400 text-sm">Receive notifications about new features and updates</p>
            </div>
            <div className="flex items-center">
              <Button className="bg-primary-200 text-dark-100 rounded-full px-4 py-2">
                Enabled
          ...
          <div className="flex items-center justify-between py-3 border-b border-dark-300">
            <div>
              ...
              <p className="text-light-400 text-sm">Use dark mode for the application interface</p>
            </div>
            <div className="flex items-center">
              <Button className="bg-primary-200 text-dark-100 rounded-full px-4 py-2">
                Enabled
          ...
          <div className="flex items-center justify-between py-3">
            <div>
              ...
              <p className="text-light-400 text-sm">Enable sound effects during interviews</p>
            </div>
            <div className="flex items-center">
              <Button className="bg-primary-200 text-dark-100 rounded-full px-4 py-2">
                Enabled
